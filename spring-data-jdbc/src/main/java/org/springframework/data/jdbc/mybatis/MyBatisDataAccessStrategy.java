...
public class MyBatisDataAccessStrategy implements DataAccessStrategy {
	...
	public <T> Stream<T> findAllStreamable(Class<T> domainType) {
		String statement = namespace(domainType) + ".findAllStreamable";
		MyBatisContext parameter = new MyBatisContext(null, null, domainType, Collections.emptyMap());
	...
	public <T> Stream<T> findAllByIdStreamable(Iterable<?> ids, Class<T> domainType) {
		String statement = namespace(domainType) + ".findAllByIdStreamable";
	...
	public <T> Stream<T> findAllStreamable(Class<T> domainType, Sort sort) {
		...
		String statement = namespace(domainType) + ".findAllSortedStreamable";
	...
	@Override
	public <T> Stream<T> findAllStreamable(Query query, Class<T> probeType) {
		throw new UnsupportedOperationException("Not implemented");
	}
