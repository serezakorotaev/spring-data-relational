...
public interface JdbcAggregateOperations {
	 ...
	 */
	<T> Stream<T> findAllByIdStreamable(Iterable<?> ids, Class<T> domainType);
	 ...
	 * @return Guaranteed to be not {@code null}.
	 */
	<T> Stream<T> findAllStreamable(Class<T> domainType);
	 ...
	 * @since 2.0
	 */
	<T> Stream<T> findAllStreamable(Class<T> domainType, Sort sort);
	 ...
	 * @since 3.0
	 */
	<T> Stream<T> findAllStreamable(Query query, Class<T> domainType);
