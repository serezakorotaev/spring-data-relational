...
abstract class AbstractJdbcAggregateTemplateIntegrationTests {
	...
	void saveAndLoadManeEntitiesWithReferenceEntityLikeStream() {
		...
		Stream<LegoSet> streamable = template.findAllStreamable(LegoSet.class);
	...
	void saveAndLoadManyEntitiesWithReferencedEntitySortedLikeStream() {
		...
		Stream<LegoSet> reloadedLegoSets = template.findAllStreamable(LegoSet.class, Sort.by("name"));
	...
	void findByNonPropertySortLikeStreamFails() {
		assertThatThrownBy(() -> template.findAllStreamable(LegoSet.class, Sort.by("somethingNotExistant")))
				.isInstanceOf(InvalidPersistentPropertyPath.class);
	}
	...
	void saveAndLoadManyEntitiesByIdWithReferencedEntityLikeStream() {
		...
		Stream<LegoSet> reloadedLegoSets = template.findAllByIdStreamable(singletonList(legoSet.id), LegoSet.class);
